...
$fields['nombre'] = array(true, false, 2, 50);
...
<?php
	if($id){form_header('<h4>Actualizar Sector</h4>',false,false);}
	else{form_header('<h4>Agregar Nuevo Sector</h4>',false,false);}
?>
